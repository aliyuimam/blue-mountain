...
const error = () => {
  ...
  <div className="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
    ...
    <img src="https://img.freepik.com/premium-vector/illustration-vector-graphic-cartoon-character-404-network-disruption_516790-2349.jpg?uid=R161900530&ga=GA1.1.1966968690.1726042054&semt=ais_hybrid" />
    </div>
  </div>
</div>
